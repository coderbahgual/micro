...
IPAddress ip(192, 168, 0, 177); // Endereço IP que a Ethernet Shield terá. Deve ser alterado para um endereço livre da sua rede.
        ...
        while (client.connected()) {
            if (client.available()) {   // os dados do cliente estão disponiveis para serem lidos
                ...
                if (c == '\n' && currentLineIsBlank) {
                    ...
                    client.println("<h1>##### VITORIA DA LOURDINHA #####</h1>");
                    client.println("</body>");
                    client.println("</html>");
                    break;
                }
